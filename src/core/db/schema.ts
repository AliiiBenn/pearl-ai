import { pgTable, text, varchar, timestamp, boolean, uuid, jsonb } from 'drizzle-orm/pg-core';
...
export const messages = pgTable('messages', {
  ...
  content: text('content'), // Rendre nullable
  rawParts: jsonb('raw_parts').$type<AIMessage['parts']>(), // Nouvelle colonne pour les parties structurées du message
